...
$result = $conn->query("SELECT * FROM slider_hero ORDER BY id DESC");
?>
...
<head>
    ...
    <title>Kelola Slider Hero</title>
    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4 border-bottom">
                <h1 class="h2 text-dark"><i class="fas fa-images me-2 text-secondary"></i> Kelola Slider Hero</h1>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="d-flex justify-content-start mb-3">
                        <a href="slider_create.php" class="btn btn-secondary shadow-sm">
                    ...
                    <div class="card shadow-sm mb-4">
                        <div class="card-header bg-secondary text-white">
                            <h5 class="mb-0">Daftar Gambar Slider Utama</h5>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php if ($result->num_rows > 0): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="../../assets/sliders/<?= $row['gambar']; ?>" 
                                                        alt="Slider Image" 
                                                        width="150" height="70" class="object-fit-cover">
                                                </td>
                                                <td class="text-center">
                                                    <a href="slider_edit.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-warning me-1" title="Edit">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <a href="../../controllers/slider_delete.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin hapus slider ini?')" title="Hapus">
                                            ...
                                            <?php endwhile; ?>
                                        <?php else: ?>
                                            <tr><td colspan="5" class="text-center py-4 text-muted"><i class="fas fa-box-open me-2"></i> Belum ada data slider.</td></tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
                            </div> </div>
