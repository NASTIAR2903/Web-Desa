...
<head>
    ...
    <title>Edit Pengumuman: <?= htmlspecialchars($data['judul'] ?? 'N/A'); ?></title>
    ...
    <nav id="sidebarMenu" class="sidebar col-md-3 col-lg-2 d-md-block collapse">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4 border-bottom">
                <h1 class="h2 text-dark"><i class="fas fa-edit me-2 text-warning"></i> Edit Pengumuman:</h1>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card shadow-lg mb-4 border-warning border-start border-4">
                        <div class="card-header bg-warning text-dark">
                            <h5 class="mb-0">Formulir Edit Pengumuman</h5>
                        </div>
                        <div class="card-body">
                            
                            <form action="../../controllers/pengumuman_update.php" method="POST"> 
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="isi" id="isi" rows="5" class="form-control" required><?= htmlspecialchars($data['isi'] ?? ''); ?></textarea>
                                </div>
                                
                                <div class="mb-3">
                                    <label for="tanggal_pelaksanaan" class="form-label fw-bold">Tanggal Pelaksanaan</label>
                                    <input type="date" name="tanggal_pelaksanaan" id="tanggal_pelaksanaan" class="form-control" value="<?= $data['tanggal_pelaksanaan']; ?>">
                                </div>
                                ...
                                <a href="pengumuman_index.php" class="btn btn-outline-secondary">
