...
<head>
    ...
    <title>Edit Berita: <?= htmlspecialchars($data['judul'] ?? 'N/A'); ?></title>
    ...
    <nav id="sidebarMenu" class="sidebar col-md-3 col-lg-2 d-md-block collapse">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4 border-bottom">
                <h1 class="h2 text-dark"><i class="fas fa-edit me-2 text-warning"></i> Edit Berita:</h1>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card shadow-lg mb-4 border-warning border-start border-4">
                        <div class="card-header bg-warning text-dark">
                            <h5 class="mb-0">Formulir Edit Berita</h5>
                        </div>
                        <div class="card-body">
                            ...
                            <form action="../../controllers/berita_update.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <?php if($data['gambar']): ?>
                                        <img src="../../assets/berita/<?= $data['gambar']; ?>" alt="Gambar Berita" width="150" class="mb-2 form-gambar-preview">
                                    <?php else: ?>
                                ...
                                <button type="submit" class="btn btn-warning me-2">
                                    <i class="fas fa-sync-alt me-1"></i> Update Berita
                                </button>
