...
<head>
    ...
    <title>Kelola Pengumuman Desa</title>
    ...
    <nav id="sidebarMenu" class="sidebar col-md-3 col-lg-2 d-md-block collapse">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4 border-bottom">
                <h1 class="h2 text-dark"><i class="fas fa-bullhorn me-2 text-danger"></i> Kelola Pengumuman</h1>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <a href="pengumuman_create.php" class="btn btn-danger shadow-sm">
                    ...
                    <div class="card shadow-sm mb-4">
                        <div class="card-header bg-danger text-white">
                            <h5 class="mb-0">Daftar Pengumuman Desa</h5>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        <?php if ($result->num_rows > 0): ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-danger">
                                                            <i class="fas fa-calendar-alt"></i> <?= date('d M Y', strtotime($row['tanggal_pelaksanaan'])); ?>
                                                        </span>
                                                    </td>
                                                    <td><?= date('d M Y', strtotime($row['created_at'])); ?></td>
                                                    <td class="text-center">
                                                        <a href="pengumuman_edit.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-warning me-1" title="Edit">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <a href="../../controllers/pengumuman_delete.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Hapus pengumuman: <?= htmlspecialchars($row['judul']); ?>?')" title="Hapus">
                                            ...
                                            <?php endwhile; ?>
                                        <?php else: ?>
                                            <tr><td colspan="5" class="text-center py-4 text-muted"><i class="fas fa-box-open me-2"></i> Belum ada data pengumuman.</td></tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
                            </div> </div>
