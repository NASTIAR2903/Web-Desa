...
<head>
    ...
    <title>Kelola Berita Desa</title>
    ...
    <nav id="sidebarMenu" class="sidebar col-md-3 col-lg-2 d-md-block collapse">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4 border-bottom">
                <h1 class="h2 text-dark"><i class="fas fa-newspaper me-2 text-info"></i> Kelola Berita Desa</h1>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <a href="berita_create.php" class="btn btn-info text-white shadow-sm">
                    ...
                    <div class="card shadow-sm mb-4">
                        <div class="card-header bg-info text-white">
                            <h5 class="mb-0">Daftar Berita dan Pengumuman</h5>
                        </div>
                        <div class="card-body">
                                            ...
                                            <?php $no=1; while($row=$result->fetch_assoc()): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php else: ?>
                                                            <span class="text-muted small"><i class="fas fa-image"></i> Tidak ada gambar</span>
                                                        <?php endif; ?>
                                                    </td>
                                                    <td><span class="badge bg-secondary"><i class="fas fa-calendar-alt"></i> <?= date('d M Y', strtotime($row['created_at'])); ?></span></td>
                                                    <td class="text-center">
                                                        <a href="berita_edit.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-warning me-1" title="Edit">
                                                            <i class="fas fa-edit"></i> Edit
                                                        </a>
                                                        <a href="../../controllers/berita_delete.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin hapus berita: <?= htmlspecialchars($row['judul']); ?>?')" title="Hapus">
