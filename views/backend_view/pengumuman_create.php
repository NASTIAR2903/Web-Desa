    ...
    <nav id="sidebarMenu" class="sidebar col-md-3 col-lg-2 d-md-block collapse">
            <div class="sidebar-sticky pt-3">
                <ul class="nav flex-column px-3">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link active" href="pengumuman_index.php">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4 border-bottom">
                <h1 class="h2 text-dark"><i class="fas fa-plus me-2 text-danger"></i> Tambah Pengumuman</h1>
                <div class="btn-toolbar mb-2 mb-md-0">
                    <a href="pengumuman_index.php" class="btn btn-sm btn-outline-secondary">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    ...
                    <div class="card shadow-lg mb-4 border-danger border-start border-4">
                        <div class="card-header bg-danger text-white">
                            <h5 class="mb-0">Formulir Pengumuman Baru</h5>
                        </div>
                        <div class="card-body">
                            
                            <form action="../../controllers/pengumuman_store.php" method="POST">
                                
                                <div class="mb-3">
                                    <label for="judul" class="form-label fw-bold">Judul</label>
                                    <input type="text" name="judul" id="judul" class="form-control" placeholder="Contoh: Kerja Bakti Massal" required>
                                </div>
                                
                                <div class="mb-3">
                                    <label for="isi" class="form-label fw-bold">Isi Pengumuman</label>
                                    <textarea name="isi" id="isi" rows="5" class="form-control" placeholder="Jelaskan detail pengumuman..." required></textarea>
                                  </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">Tanggal acara atau batas waktu pengumuman.</small>
                                </div>
                                ...
                                <a href="crud_pengumuman.php" class="btn btn-outline-secondary">
