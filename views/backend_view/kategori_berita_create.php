...
// Bagian PHP Anda (jika ada) tetap di atas
?>
    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4 border-bottom">
                <h1 class="h2 text-dark"><i class="fas fa-plus me-2 text-info"></i> Tambah Kategori Berita</h1>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card shadow-lg mb-4 border-info border-start border-4">
                        <div class="card-header bg-info text-white">
                            <h5 class="mb-0">Formulir Kategori Baru</h5>
                        </div>
                        <div class="card-body">
                            
                            <form action="../../controllers/kategori_berita_store.php" method="POST">
                                
                                <div class="mb-3">
                                    <label for="nama_kategori" class="form-label fw-bold">Nama Kategori</label>
                                    <input type="text" name="nama_kategori" id="nama_kategori" class="form-control" placeholder="Contoh: Kegiatan Warga" required>
                                </div>
