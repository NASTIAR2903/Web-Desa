...
$id = $_GET['id'];
$sql = "SELECT * FROM kategori_berita WHERE id=$id";
...
<head>
    ...
    <title>Edit Kategori: <?= htmlspecialchars($kategori['nama_kategori'] ?? 'N/A'); ?></title>
    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4 border-bottom">
                <h1 class="h2 text-dark"><i class="fas fa-edit me-2 text-warning"></i> Edit Kategori: <span class="text-info"><?= htmlspecialchars($kategori['nama_kategori'] ?? ''); ?></span></h1>
                <div class="btn-toolbar mb-2 mb-md-0">
                    <a href="kategori_berita_index.php" class="btn btn-sm btn-outline-secondary">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card shadow-lg mb-4 border-warning border-start border-4">
                        <div class="card-header bg-warning text-dark">
                            <h5 class="mb-0">Formulir Edit Kategori</h5>
                        </div>
                        <div class="card-body">
                            
                            <form action="../../controllers/kategori_berita_update.php" method="POST">
                                ...
                                <a href="kategori_berita_index.php" class="btn btn-outline-secondary">
