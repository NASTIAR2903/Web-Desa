...
<head>
    ...
    <title>Tambah Slider Hero</title>
    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4 border-bottom">
                <h1 class="h2 text-dark"><i class="fas fa-plus me-2 text-secondary"></i> Tambah Slider Hero</h1>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    ...
                    <div class="card shadow-lg mb-4 border-secondary border-start border-4">
                        <div class="card-header bg-secondary text-white">
                            <h5 class="mb-0">Formulir Slider Baru</h5>
                        </div>
                        <div class="card-body">
                            
                            <form action="../../controllers/slider_store.php" method="POST" enctype="multipart/form-data">
                                
                                <div class="mb-3">
                                    <label for="judul" class="form-label fw-bold">Judul</label>
                                    <input type="text" name="judul" id="judul" class="form-control" placeholder="Judul singkat slider" required>
                                </div>
                                
                                <div class="mb-3">
                                    <label for="deskripsi" class="form-label fw-bold">Deskripsi</label>
                                    <textarea name="deskripsi" id="deskripsi" rows="3" class="form-control" placeholder="Deskripsi singkat atau sub-judul"></textarea>
                                </div>
                                
                                <div class="mb-3">
                                    <label for="gambar" class="form-label fw-bold">Gambar</label>
                                    <input type="file" name="gambar" id="gambar" class="form-control" required>
                                    <small class="text-muted">Pilih gambar utama untuk slider (rasio lebar, misalnya 16:9).</small>
                                </div>
